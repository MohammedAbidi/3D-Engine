#ifndef RD_ENGINE_RAYTRACE_H
#define RD_ENGINE_RAYTRACE_H

#include "rd_enginebase.h" // Brings with it vector and string
...
class RERay: public RenderEngine
{
public:
...
// Empty (only exists so I can compile with libcs697.o)
#ifndef RD_ENGINE_DIRECT_H
#define RD_ENGINE_DIRECT_H
class REDirect: public RenderEngine {
    virtual int rd_render_init();
};
int REDirect::rd_render_init() {return 0;}
#endif // RD_ENGINE_DIRECT_H


#endif // RD_ENGINE_RAYTRACE_H